#ifndef DBASE_STL_UNORDERED_SET_H_
#define DBASE_STL_UNORDERED_SET_H_
...
//
// 异常保证：
// dbase::stl::unordered_set<Key> / dbase::stl::unordered_multiset<Key> 满足基本异常保证，对以下等函数做强异常安全保证：
//   * emplace
//   * emplace_hint
//   * insert
...
// 参数一代表键值类型，参数二代表哈希函数，缺省使用 dbase::stl::hash，
// 参数三代表键值比较方式，缺省使用 dbase::stl::equal_to
template <class Key, class Hash = dbase::stl::hash<Key>, class KeyEqual = dbase::stl::equal_to<Key>>
class unordered_set
{
    private:
        // 使用 hashtable 作为底层机制
...
#endif  // !DBASE_STL_UNORDERED_SET_H_
