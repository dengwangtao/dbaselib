#ifndef DBASE_STL_ITERATOR_H_
#define DBASE_STL_ITERATOR_H_
...
// template <class Iter>
// struct is_exactly_input_iterator : public dbase::stl::bool_constant<has_iterator_cat_of_v<Iter, input_iterator_tag> && !has_iterator_cat_of_v<Iter, forward_iterator_tag>> {};

template <class Iter, class = void>
struct is_exactly_input_iterator : dbase::stl::false_type
{
};

template <class Iter>
struct is_exactly_input_iterator<Iter,
                                 std::enable_if_t<has_iterator_cat_of_v<Iter, input_iterator_tag> && !has_iterator_cat_of_v<Iter, forward_iterator_tag>, void>> : dbase::stl::true_type
{
};
