#ifndef DBASE_STL_SET_H_
#define DBASE_STL_SET_H_
...
//
// 异常保证：
// dbase::stl::set<Key> / dbase::stl::multiset<Key> 满足基本异常保证，对以下等函数做强异常安全保证：
//   * emplace
//   * emplace_hint
//   * insert
...
// 模板类 set，键值不允许重复
// 参数一代表键值类型，参数二代表键值比较方式，缺省使用 dbase::stl::less
template <class Key, class Compare = dbase::stl::less<Key>>
class set
{
    public:
