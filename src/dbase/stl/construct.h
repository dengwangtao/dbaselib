#ifndef DBASE_STL_CONSTRUCT_H_
#define DBASE_STL_CONSTRUCT_H_
...
{
    ::new ((void*)ptr) Ty(dbase::stl::forward<Args>(args)...);  // 使用placement new 在 ptr地址上构造Ty对象, 调用多个参数的构造函数, 转发参数包
}
